...
def _create_vision_transformer(variant, pretrained=False, url=None, default_cfg=None, **kwargs):
...
@register_model
def vit_tiny_patch16_224(pretrained=False, url='', **kwargs):
    """ ViT-Tiny (Vit-Ti/16)
    """
    model_kwargs = dict(patch_size=16, embed_dim=192, depth=12, num_heads=3, **kwargs)
    model = _create_vision_transformer('vit_tiny_patch16_224', pretrained=pretrained, url=url, **model_kwargs)
    return model
